...
echo "start running log_Ni67_gs8_tr_j3p_j1n.txt ..."
cat > Ni67_gs8_3p_1n.input <<EOF
&input
  fn_int   = "gs8.snt"
...
&end
EOF
mpiexec ./transit.exe Ni67_gs8_3p_1n.input > log_Ni67_gs8_tr_j3p_j1n.txt  

rm -f Ni67_gs8_3p_1n.input
